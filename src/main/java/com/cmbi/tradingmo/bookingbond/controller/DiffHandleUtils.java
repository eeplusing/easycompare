...
public class DiffHandleUtils {
    ...
    public static void main(String[] args)  {
        //对比 F:\n1.txt和 F:\n2.txt 两个文件，获得不同点
        List<String> diffString = DiffHandleUtils.diffString("D:\\workspace\\tmo-pbot-cfund\\src\\main\\resources\\ACCOUNT_4-7-2022_1041-26190.csv","D:\\workspace\\tmo-pbot-cfund\\src\\main\\resources\\ACCOUNT_4-7-2022_1041-26191.csv");
        //在F盘生成一个diff.html文件，打开便可看到两个文件的对比
        DiffHandleUtils.generateDiffHtml(diffString,"D:\\workspace\\tmo-pbot-cfund\\src\\main\\resources\\diff.html");
    }
    ...
    public static void generateDiffHtml(List<String> diffString, String htmlPath) {
       ...
       //如果打开html为空白界面，可能cdn加载githubCss失败 ,githubCss 链接可替换为 https://cdnjs.cloudflare.com/ajax/libs/highlight.js/10.7.1/styles/github.min.css
        String githubCss = "http://127.0.0.1:8080/static/github.min.css";
        ...
        String diff2htmlCss = "http://127.0.0.1:8080/static/diff2html.min.css";
        ...
        String diff2htmlJs = "http://127.0.0.1:8080/static/diff2html-ui.min.js";
